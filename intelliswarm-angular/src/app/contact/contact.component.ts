...
export class ContactComponent implements OnInit {
  ...
  success = false;
  error = '';
  mission: string = 'To empower organizations with intelligent automation solutions that transform business processes and enhance productivity. At Intelliswarm.ai, we harness the power of AI-driven technologies to streamline operations, reduce complexity, and drive data-driven decision-making. Our solutions are designed to adapt and evolve with business needs, ensuring sustainable growth, improved efficiency, and a competitive edge in an ever-changing digital landscape.';
  vision: string = 'Creating a world where AI-driven workflows seamlessly integrate with human expertise to achieve unprecedented efficiency and innovation. We envision a future where businesses harness the full potential of intelligent automation, fostering collaboration between human intelligence and machine learning to unlock new opportunities, optimize resources, and redefine industry standards.';
